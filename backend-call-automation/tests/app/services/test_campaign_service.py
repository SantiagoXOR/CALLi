...
from app.models.campaign import CampaignCreate, CampaignUpdate, CampaignStats
...
@pytest.mark.asyncio
async def test_list_campaigns_with_pagination(campaign_service: CampaignService, mock_campaign_data):
    for i in range(15):
