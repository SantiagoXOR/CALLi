...
class ElevenLabsLogger:
    ...
    def _create_log_entry(self, level: str, method: str, message: str, context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    def log_api_call(self, method: str, params: Optional[Dict[str, Any]] = None, duration: Optional[float] = None, success: bool = True, response_info: Optional[Dict[str, Any]] = None):
        ...
        log_entry = self._create_log_entry("INFO" if success else "WARNING", method, message, sanitized_context)
    ...
    def log_error(self, method: str, error: Exception, context: Optional[Dict[str, Any]] = None):
        ...
        message = f"Error during {method}: {str(error)}"
        error_context = {
        ...
        self.logger.error(json.dumps(log_entry), exc_info=False) # Set exc_info=True if traceback is needed

    def log_info(self, method: str, message: str, context: Optional[Dict[str, Any]] = None):
