...
AI_RESPONSE_TIME = Histogram(MetricNames.AI_RESPONSE_TIME, 'Tiempo de procesamiento de respuestas de IA')
...
AI_SENTIMENT_SCORE = Gauge(MetricNames.AI_SENTIMENT_SCORE, 'Puntuación de sentimiento detectado por IA')
...
class AIMetricsService:
    ...
    async def record_conversation_metrics(
        ...
        try:
            # Guardar en Supabase
            await supabase_client.table('conversation_metrics').insert({
