...
class AuthService:
    ...
    async def get_user_roles(self, user_id: str) -> List[str]:
        ...
        try:
            ...
            logger.error(f"Error al obtener roles de usuario: {str(e)}")
            return []
    ...
    async def check_permission(self, user_id: str, permission: str) -> bool:
        ...
        try:
            ...
            for role in roles:
                ...
                response = self.supabase.table("role_permissions").select("permission").eq("role", role).execute()
    ...
    async def assign_role(self, user_id: str, role: str) -> bool:
        ...
        try:
            ...
            response = self.supabase.table("user_roles").select("*").eq("user_id", user_id).eq("role", role).execute()
    ...
    async def remove_role(self, user_id: str, role: str) -> bool:
        ...
        try:
            # Eliminar rol
            self.supabase.table("user_roles").delete().eq("user_id", user_id).eq("role", role).execute()
